...
import com.example.serialcommunications.exception.SendDataToSerialPortFailure;
import com.example.serialcommunications.exception.SerialPortInputStreamCloseFailure;
import com.example.serialcommunications.exception.SerialPortOutputStreamCloseFailure;
...
public class SerialPortManager {
   ...
   */
  public static SerialPort openPort(String portName, int baudrate, int databits, int parity, int stopbits) throws SerialPortParameterFailure, NotASerialPort, NoSuchPort, PortInUse {
